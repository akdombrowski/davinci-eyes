...
function App() {
  ...
  return (
    <ErrorBoundary
      ...
      <Container
        fluid
        className="p-0 m-0 bg-dark justify-content-center overflow-hidden"
        style={{
          height: "100vh",
          width: "100vw",
        }}>
              ...
              <Row className="pb-5">
                ...
                <Col
                  ...
                  <h6 className="col-12 display-9 text-info text-center">
                    A Viewer for DaVinci flow files!
                  </h6>
                </Col>
              </Row>
              <Row>
            ...
            <Col
              ...
              <Row
                ...
                <Col xs={12}>
                  <Row className="pb-1">
                    <Col xs={12}>
                      <p className="display-8 p-0 text-light text-center font-monospace fw-lighter text-break">
                        Generates visualizations of DaVinci JSON file exports.
                      </p>
                    </Col>
                  </Row>
                  <Row className="pb-1">
                    <Col xs={12}>
                      <p className="fs-6 p-0 text-light text-center font-monospace fw-lighter text-break">
                        Haven&apos;t gotten around to setting up a PingOne
                        account, yet?
                      </p>
                      <p className="fs-6 p-0 text-light text-center font-monospace fw-lighter text-break">
                        {/* add link to first sentence to point to trial registration */}
                        Well, first off, you should. But, that&apos;s not why
                        you&apos;re here, is it?
                      </p>
                    </Col>
                  </Row>
                      ...
                      <ul>
                        <li>
                          <p className="fs-6 p-0 text-warning text-start font-monospace fw-lighter text-break">
                            ...
                            using this tool. It won&apos;t blow up or anything,
                            but you&apos;ll be sad.
                          </p>
                        </li>
                        <li>
